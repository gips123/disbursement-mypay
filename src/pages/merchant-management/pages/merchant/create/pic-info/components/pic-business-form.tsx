...
const picBusinessSchema = z.object({
...
type PicBusinessFormData = z.infer<typeof picBusinessSchema>;

export function PicBusinessForm() {
  const {
    register,
    handleSubmit,
    ...
    setValue,
    watch,
  } = useForm<PicBusinessFormData>({
    resolver: zodResolver(picBusinessSchema),
  });

  const onSubmit = (data: PicBusinessFormData) => {
    console.log('PIC Business Data:', data);
  };
