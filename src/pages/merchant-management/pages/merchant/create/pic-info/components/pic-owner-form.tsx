...
type PicOwnerFormData = z.infer<typeof picOwnerSchema>;

export function PicOwnerForm() {
  const {
    register,
    handleSubmit,
    ...
    setValue,
    watch,
  } = useForm<PicOwnerFormData>({
    resolver: zodResolver(picOwnerSchema),
  });

  const onSubmit = (data: PicOwnerFormData) => {
    console.log('PIC Owner Data:', data);
  };
