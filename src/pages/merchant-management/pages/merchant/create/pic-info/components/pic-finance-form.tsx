...
const picFinanceSchema = z.object({
...
type PicFinanceFormData = z.infer<typeof picFinanceSchema>;

export function PicFinanceForm() {
  const {
    register,
    handleSubmit,
    ...
    setValue,
    watch,
  } = useForm<PicFinanceFormData>({
    resolver: zodResolver(picFinanceSchema),
  });

  const onSubmit = (data: PicFinanceFormData) => {
    console.log('PIC Finance Data:', data);
  };
